...
<textarea id='Msg' style='display:none' name='premoto' ></textarea>
<br>
<textarea id="userFied" placeholder="premoto"></textarea>
<br>
<input type="submit"/>
</form>
...
$text = preg_replace("#\[sp]#","&nbsp;",$text);
	...
	$insert = mysql_query("INSERT INTO `moto_table`(`premoto`)
VALUES ('$text')");
if(!$insert)
{
	echo mysql_error();
